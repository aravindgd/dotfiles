...
require('lazy').setup({
  ...
  -- for easy snakecase <-> camelcase <-> mixedcase
  'tpope/vim-abolish',

  -- Vim bracket/parentheses wrapping
  'tpope/vim-surround',

  -- Sensible relative numbering
...
-- NOTE: You should make sure your terminal supports thi
...
--  this will use mason to manage the lsp server
local servers = {
  -- clangd = {},
  -- gopls = {},
  -- pyright = {},
